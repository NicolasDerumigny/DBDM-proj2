...
\subsection{Data reprensentation}
Tools like sklearn.feature_extraction.text.CountVectorizer allows us to transform the way data are represented in a matrix
