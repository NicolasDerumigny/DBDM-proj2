...
\hline
\end{tabular}
\captionof{figure}{\label{fig:image5} Before the campaign Hierarchical clustering on hashtags}
\bigskip
...
\end{tabular}
\bigskip
\captionof{figure}{\label{fig:image6} During the campaign Hierarchical clustering on hashtags}
\end{multicols}
\end{center}
\end{figure}
